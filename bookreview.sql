...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 26, 2024 lúc 12:51 PM
...
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:35 AM
--
...
INSERT DELAYED IGNORE INTO `admin` (`Name`, `Password`) VALUES
('Admin', '1234567');
...
--
-- Tạo: Th9 25, 2024 lúc 12:04 PM
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:46 AM
--
...
--
-- RELATIONSHIPS FOR TABLE `book_rating`:
--   `BookID`
--       `books` -> `BookID`
--   `UserID`
--       `users` -> `UserID`
...
INSERT DELAYED IGNORE INTO `book_rating` (`UserID`, `BookID`, `rate`) VALUES
(1, 6, 5),
(1, 3, 4),
(1, 2, 4),
(1, 4, 3),
...
--
-- Tạo: Th9 25, 2024 lúc 11:29 AM
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:48 AM
--
...
INSERT DELAYED IGNORE INTO `comment` (`CommentID`, `UserID`, `BookID`, `Comment`, `Create_at`) VALUES
...
--
-- Tạo: Th9 25, 2024 lúc 11:54 AM
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:50 AM
--
...
--
-- RELATIONSHIPS FOR TABLE `comment_rating`:
--   `CommentID`
--       `comment` -> `CommentID`
--   `UserID`
--       `users` -> `UserID`
...
INSERT DELAYED IGNORE INTO `comment_rating` (`CommentID`, `UserID`, `rate`) VALUES
(1, 2, 5),
(2, 2, 4);
...
--
-- Tạo: Th9 26, 2024 lúc 08:57 AM
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:45 AM
--
...
--
-- Tạo: Th9 25, 2024 lúc 11:18 AM
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:41 AM
--

CREATE TABLE IF NOT EXISTS `topicbook` (
...
--
-- RELATIONSHIPS FOR TABLE `topicbook`:
--   `BookID`
--       `books` -> `BookID`
--   `TopicID`
--       `topics` -> `TopicID`
...
INSERT DELAYED IGNORE INTO `topicbook` (`TopicID`, `BookID`) VALUES
(1, 2),
(2, 2),
(5, 4),
(3, 6);
...
--
-- Tạo: Th9 25, 2024 lúc 11:04 AM
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:38 AM
--
...
INSERT DELAYED IGNORE INTO `topics` (`TopicID`, `Topicname`) VALUES
(1, 'Self-help '),
(2, 'Kinh tế'),
(3, 'Tiểu Thuyết'),
(4, 'Lịch sử'),
...
--
-- Tạo: Th9 25, 2024 lúc 11:04 AM
-- Cập nhật lần cuối: Th9 26, 2024 lúc 10:49 AM
--
...
INSERT DELAYED IGNORE INTO `users` (`UserID`, `Email`, `Username`, `Password`, `Avatar`) VALUES
(1, 'Huyenngoc3654238@gmail.com', 'Huyen', '1234567', NULL),
(2, 'le3654238@gmail.com', 'Mây', '1234567', NULL);
...
--
ALTER TABLE `comment`
  ADD CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`BookID`) REFERENCES `books` (`BookID`),
...
--
-- Siêu dữ liệu cho bảng admin
--

--
-- Siêu dữ liệu cho bảng books
--

--
-- Siêu dữ liệu cho bảng book_rating
--

--
-- Siêu dữ liệu cho bảng comment
--

--
-- Siêu dữ liệu cho bảng comment_rating
--
...
--
-- Siêu dữ liệu cho bảng topicbook
--

--
-- Siêu dữ liệu cho bảng topics
--
...
--
-- Siêu dữ liệu cho cơ sở dữ liệu bookreview
--
COMMIT;
